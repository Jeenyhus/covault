        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="text-center p-6 bg-gray-100 rounded-lg shadow-md">
              <img src="/public/file.svg" alt="Eligibility Check" className="w-16 mx-auto mb-4" />
            ...
            <div className="text-center p-6 bg-gray-100 rounded-lg shadow-md">
              <img src="/public/globe.svg" alt="Loan Calculator" className="w-16 mx-auto mb-4" />
            ...
            <div className="text-center p-6 bg-gray-100 rounded-lg shadow-md">
              <img src="/public/window.svg" alt="Instant Application" className="w-16 mx-auto mb-4" />
